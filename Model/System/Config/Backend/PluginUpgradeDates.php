...
class PluginUpgradeDates extends \Magento\Framework\App\Config\Value
{
     ...
     * @param \Sapient\AccessWorldpay\Model\System\Config\Backend\PluginVersionHistory $versionhistory
    ...
    public function __construct(
        ...
        \Sapient\AccessWorldpay\Model\System\Config\Backend\PluginVersionHistory $versionhistory,
    ...
    public function getUpgradeDates()
    {
        ...
        $versionHistoryData = explode(',', (string)$pastversions);
        $datesHistoryData = [];
        if (!empty($currentHistoryData)) {
            $datesHistoryData = explode(',', (string)$currentHistoryData);
        }
        ...
        if (empty($currentPluginData) ||
            ...
            if (preg_match('/,/', (string)$currentPluginData)) {
